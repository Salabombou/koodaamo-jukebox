...
namespace KoodaamoJukebox.Api.Services
{
    ...
    {
        private KoodaamoJukeboxDbContext _dbContext = null!; // Initialized in ExecuteAsync
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _dbContext = scope.ServiceProvider.GetRequiredService<KoodaamoJukeboxDbContext>();
