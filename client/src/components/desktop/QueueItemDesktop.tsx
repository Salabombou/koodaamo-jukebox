          ...
          <ContextMenuDesktop items={contextMenuItems} controlsDisabled={controlsDisabled}>
            <div className="flex flex-row-reverse xl:flex-row items-center w-full h-full select-none">
              ...
              <div className="flex items-center w-full min-w-0" onDoubleClick={controlsDisabled ? undefined : () => onSkip(index)}>
                <div className="md:aspect-video aspect-square h-16 w-16 md:h-16 md:w-auto flex flex-shrink-0 items-center justify-center overflow-hidden bg-black relative select-none">
                  <img
                    src={thumbnailUrl}
                    loading="lazy"
